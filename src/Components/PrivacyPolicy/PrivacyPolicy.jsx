...
const PrivacyPolicy = () => {
  return (
    ...
    >
      ...
      <p>
        {" "}
        At TreeVed, accessible from <Link color="007bff">www.treeved.com</Link>,
        one of our main priorities is the privacy of our visitors. This Privacy
        Policy document contains types of information that is collected and
        recorded by TreeVed and how we use it.
        <br /> <br /> If you have additional questions or require more
        information about our Privacy Policy, do not hesitate to contact us.
        This Privacy Policy applies only to our online activities and is valid
        for visitors to our website with regards to the information that they
        shared and/or collect in TreeVed. This policy is not applicable to any
        information collected offline or via channels other than this website.
        Our Privacy Policy wSas created with the help of the Privacy Policy
        Generator and the Free Privacy Policy Generator. Consent By using our
        website, you hereby consent to our Privacy Policy and agree to its
        terms. For our Terms and Conditions, please visit the Terms HYPERLINK
        <Link>
          "https://www.privacypolicyonline.com/terms-conditions-generator/"
        </Link>
      ...
      <p>
        ...
        <br />
        <br /> If you contact us directly, we may receive additional information
        ...
        <br /> We use the information we collect in various ways, including:{" "}
        <br />
        <br />
        Provide, operate, and maintain our website <br />
        Improve, personalise, and expand our website
        <br /> Understand and analyse how you use our website Develop new
        ...
        Find and prevent fraud. Log Files TreeVed follows a standard procedure
        ...
        purpose of the data is for analysing trends, administering the site,
        tracking users' movement on the website, and gathering demographic
        information. Cookies and Web Beacons Like any other website, TreeVed
        ...
        accessed or visited. The information is used to optimise the users'
        experience by customising our web page content based on visitors'
        browser type and/or other information. Google DoubleClick DART Cookie
        ...
        Some of the advertisers on our site may use cookies and web beacons. Our
        ...
        for each of the advertising partners of TreeVed. Third-party ad servers
        or ad networks uses technologies like cookies, JavaScript, or Web
        Beacons that are used in their respective advertisements and links that
        appear on TreeVed, which are sent directly to users' browser. They
        ...
        websites that you visit. Note that TreeVed has no access to or control
        over these cookies that are used by third-party advertisers. Third-Party
        Privacy Policies TreeVed's Privacy Policy does not apply to other
        ...
        guide their online activity. TreeVed does not knowingly collect any
        Personal Identifiable Information from children under the age of 13. If
        you think that your child provided this kind of information on our
